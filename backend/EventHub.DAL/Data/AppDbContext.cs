    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                new Category { Id = "cat-music", Name = "Music" },
                new Category { Id = "cat-tech", Name = "Technology" },
                new Category { Id = "cat-art", Name = "Art" },
                new Category { Id = "cat-sport", Name = "Sport" },
                new Category { Id = "cat-health", Name = "Health" },
                new Category { Id = "cat-entertainment", Name = "Entertainment" },
                new Category { Id = "cat-business", Name = "Business" },
                new Category { Id = "cat-education", Name = "Education" }
            );
